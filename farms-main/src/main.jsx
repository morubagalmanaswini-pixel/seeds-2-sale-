...
import { detectFarmerNeed, findNavigationTarget } from './lib/voiceNavigation';
...
async function getAuthenticatedProfile(token) {
  const getSupabaseProfile = async () => {
    ...
    const role = ['admin', 'customer_care', 'consumer', 'farmer', 'delivery_partner'].includes(metadata.role) ? metadata.role : 'consumer';
...
const supportSurfaceTranslations = {
  en: {
    'ONE-STOP FARMER SERVICES': 'ONE-STOP FARMER SERVICES', 'Farmer': 'Farmer', 'Help Desk': 'Help Desk', 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.': 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.', 'WHAT DO YOU NEED HELP WITH?': 'WHAT DO YOU NEED HELP WITH?', 'SERVICE CATEGORIES': 'SERVICE CATEGORIES', 'Continue to official website': 'Continue to official website', 'TELANGANA-FIRST': 'TELANGANA-FIRST', 'Recommended for local farmers': 'Recommended for local farmers', 'Crop emergency': 'Crop emergency', 'FARMER PRIORITY SUPPORT': 'FARMER PRIORITY SUPPORT', 'What happened?': 'What happened?', 'Choose the closest problem to get the next safest action.': 'Choose the closest problem to get the next safest action.', 'DO THIS NOW': 'DO THIS NOW', 'Contact the FarmDirect quality desk': 'Contact the FarmDirect quality desk', 'WhatsApp now': 'WhatsApp now', 'WhatsApp help': 'WhatsApp help', 'Sudden pest attack': 'Sudden pest attack', 'Leaf disease or rot': 'Leaf disease or rot', 'Storm, flood, or heat damage': 'Storm, flood, or heat damage', 'Food quality or safety concern': 'Food quality or safety concern'
  },
  hi: {
    'ONE-STOP FARMER SERVICES': 'किसानों की एक-स्टॉप सेवाएं', 'Farmer': 'किसान', 'Help Desk': 'सहायता केंद्र', 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.': 'अलग-अलग Google खोजने के बजाय किसानों के लिए ऋण, फसल बीमा, बाजार, मिट्टी और सरकारी योजनाओं की आधिकारिक जानकारी एक ही जगह पाएं।', 'WHAT DO YOU NEED HELP WITH?': 'आपको किस मदद की जरूरत है?', 'SERVICE CATEGORIES': 'सेवा श्रेणियां', 'Continue to official website': 'आधिकारिक वेबसाइट पर जाएं', 'TELANGANA-FIRST': 'तेलंगाना प्राथमिकता', 'Recommended for local farmers': 'स्थानीय किसानों के लिए सुझाव', 'Crop emergency': 'फसल आपातकाल', 'FARMER PRIORITY SUPPORT': 'किसान प्राथमिकता सहायता', 'What happened?': 'क्या हुआ?', 'Choose the closest problem to get the next safest action.': 'सही समस्या चुनें और अगला सुरक्षित कदम पाएं।', 'DO THIS NOW': 'अभी यह करें', 'Contact the FarmDirect quality desk': 'FarmDirect गुणवत्ता सहायता से संपर्क करें', 'WhatsApp now': 'अभी WhatsApp करें', 'WhatsApp help': 'WhatsApp सहायता', 'Sudden pest attack': 'अचानक कीट हमला', 'Leaf disease or rot': 'पत्तियों की बीमारी या सड़न', 'Storm, flood, or heat damage': 'तूफान, बाढ़ या गर्मी से नुकसान', 'Food quality or safety concern': 'खाद्य गुणवत्ता या सुरक्षा चिंता'
  },
  te: {
    'ONE-STOP FARMER SERVICES': 'రైతుల కోసం ఒకే చోట సేవలు', 'Farmer': 'రైతు', 'Help Desk': 'సహాయ కేంద్రం', 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.': 'వేర్వేరు Google శోధనలకు బదులుగా రుణాలు, పంట బీమా, మార్కెట్, నేల మరియు ప్రభుత్వ పథకాల అధికారిక సమాచారాన్ని ఒకే చోట పొందండి.', 'WHAT DO YOU NEED HELP WITH?': 'మీకు ఏ సహాయం కావాలి?', 'SERVICE CATEGORIES': 'సేవా విభాగాలు', 'Continue to official website': 'అధికారిక వెబ్‌సైట్‌కు వెళ్లండి', 'TELANGANA-FIRST': 'తెలంగాణకు ప్రాధాన్యత', 'Recommended for local farmers': 'స్థానిక రైతులకు సిఫార్సు', 'Crop emergency': 'పంట అత్యవసరం', 'FARMER PRIORITY SUPPORT': 'రైతు ప్రాధాన్యత సహాయం', 'What happened?': 'ఏమైంది?', 'Choose the closest problem to get the next safest action.': 'సరైన సమస్యను ఎంచుకుని తదుపరి సురక్షిత చర్యను పొందండి.', 'DO THIS NOW': 'ఇప్పుడే చేయండి', 'Contact the FarmDirect quality desk': 'FarmDirect నాణ్యత సహాయాన్ని సంప్రదించండి', 'WhatsApp now': 'ఇప్పుడే WhatsApp చేయండి', 'WhatsApp help': 'WhatsApp సహాయం', 'Sudden pest attack': 'అకస్మాత్తుగా పురుగుల దాడి', 'Leaf disease or rot': 'ఆకు వ్యాధి లేదా కుళ్ళు', 'Storm, flood, or heat damage': 'తుఫాను, వరద లేదా వేడి నష్టం', 'Food quality or safety concern': 'ఆహార నాణ్యత లేదా భద్రత సమస్య'
  },
  ta: {
    'ONE-STOP FARMER SERVICES': 'விவசாயிகளுக்கான ஒரே இட சேவைகள்', 'Farmer': 'விவசாயி', 'Help Desk': 'உதவி மையம்', 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.': 'பல Google தேடல்களுக்கு பதிலாக கடன், பயிர் காப்பீடு, சந்தை, மண் மற்றும் அரசு திட்டங்களுக்கான அதிகாரப்பூர்வ தகவலை ஒரே இடத்தில் பெறுங்கள்.', 'WHAT DO YOU NEED HELP WITH?': 'உங்களுக்கு என்ன உதவி தேவை?', 'SERVICE CATEGORIES': 'சேவை வகைகள்', 'Continue to official website': 'அதிகாரப்பூர்வ இணையதளத்திற்குச் செல்லவும்', 'TELANGANA-FIRST': 'தெலங்கானாவுக்கு முன்னுரிமை', 'Recommended for local farmers': 'உள்ளூர் விவசாயிகளுக்கான பரிந்துரை', 'Crop emergency': 'பயிர் அவசரநிலை', 'FARMER PRIORITY SUPPORT': 'விவசாயி முன்னுரிமை உதவி', 'What happened?': 'என்ன நடந்தது?', 'Choose the closest problem to get the next safest action.': 'சரியான பிரச்சினையைத் தேர்ந்தெடுத்து அடுத்த பாதுகாப்பான நடவடிக்கையைப் பெறுங்கள்.', 'DO THIS NOW': 'இப்போதே செய்யுங்கள்', 'Contact the FarmDirect quality desk': 'FarmDirect தர உதவியைத் தொடர்புகொள்ளவும்', 'WhatsApp now': 'இப்போதே WhatsApp செய்யவும்', 'WhatsApp help': 'WhatsApp உதவி', 'Sudden pest attack': 'திடீர் பூச்சித் தாக்குதல்', 'Leaf disease or rot': 'இலை நோய் அல்லது அழுகல்', 'Storm, flood, or heat damage': 'புயல், வெள்ளம் அல்லது வெப்ப சேதம்', 'Food quality or safety concern': 'உணவு தரம் அல்லது பாதுகாப்பு கவலை'
  },
  kn: {
    'ONE-STOP FARMER SERVICES': 'ರೈತರಿಗಾಗಿ ಒಂದೇ ಸ್ಥಳದ ಸೇವೆಗಳು', 'Farmer': 'ರೈತ', 'Help Desk': 'ಸಹಾಯ ಕೇಂದ್ರ', 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.': 'ಹಲವು Google ಹುಡುಕಾಟಗಳ ಬದಲು ಸಾಲ, ಬೆಳೆ ವಿಮೆ, ಮಾರುಕಟ್ಟೆ, ಮಣ್ಣು ಮತ್ತು ಸರ್ಕಾರಿ ಯೋಜನೆಗಳ ಅಧಿಕೃತ ಮಾಹಿತಿಯನ್ನು ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ ಪಡೆಯಿರಿ.', 'WHAT DO YOU NEED HELP WITH?': 'ನಿಮಗೆ ಯಾವ ಸಹಾಯ ಬೇಕು?', 'SERVICE CATEGORIES': 'ಸೇವಾ ವಿಭಾಗಗಳು', 'Continue to official website': 'ಅಧಿಕೃತ ವೆಬ್‌ಸೈಟ್‌ಗೆ ಹೋಗಿ', 'TELANGANA-FIRST': 'ತೆಲಂಗಾಣಕ್ಕೆ ಆದ್ಯತೆ', 'Recommended for local farmers': 'ಸ್ಥಳೀಯ ರೈತರಿಗೆ ಶಿಫಾರಸು', 'Crop emergency': 'ಬೆಳೆ ತುರ್ತುಸ್ಥಿತಿ', 'FARMER PRIORITY SUPPORT': 'ರೈತ ಆದ್ಯತಾ ಸಹಾಯ', 'What happened?': 'ಏನಾಯಿತು?', 'Choose the closest problem to get the next safest action.': 'ಸರಿಯಾದ ಸಮಸ್ಯೆಯನ್ನು ಆಯ್ಕೆ ಮಾಡಿ ಮುಂದಿನ ಸುರಕ್ಷಿತ ಕ್ರಮ ಪಡೆಯಿರಿ.', 'DO THIS NOW': 'ಈಗಲೇ ಮಾಡಿ', 'Contact the FarmDirect quality desk': 'FarmDirect ಗುಣಮಟ್ಟದ ಸಹಾಯವನ್ನು ಸಂಪರ್ಕಿಸಿ', 'WhatsApp now': 'ಈಗಲೇ WhatsApp ಮಾಡಿ', 'WhatsApp help': 'WhatsApp ಸಹಾಯ', 'Sudden pest attack': 'ಹಠಾತ್ ಕೀಟ ದಾಳಿ', 'Leaf disease or rot': 'ಎಲೆ ರೋಗ ಅಥವಾ ಕೊಳೆತ', 'Storm, flood, or heat damage': 'ಚಂಡಮಾರುತ, ಪ್ರವಾಹ ಅಥವಾ ಬಿಸಿಲಿನ ಹಾನಿ', 'Food quality or safety concern': 'ಆಹಾರ ಗುಣಮಟ್ಟ ಅಥವಾ ಸುರಕ್ಷತಾ ಸಮಸ್ಯೆ'
  },
  ml: {
    'ONE-STOP FARMER SERVICES': 'കർഷകർക്കായുള്ള ഏകജാലക സേവനങ്ങൾ', 'Farmer': 'കർഷകൻ', 'Help Desk': 'സഹായകേന്ദ്രം', 'Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.': 'പല Google തിരച്ചിലുകൾക്ക് പകരം വായ്പ, വിള ഇൻഷുറൻസ്, വിപണി, മണ്ണ്, സർക്കാർ പദ്ധതികൾ എന്നിവയുടെ ഔദ്യോഗിക വിവരങ്ങൾ ഒരിടത്ത് നേടൂ.', 'WHAT DO YOU NEED HELP WITH?': 'നിങ്ങൾക്ക് എന്ത് സഹായമാണ് വേണ്ടത്?', 'SERVICE CATEGORIES': 'സേവന വിഭാഗങ്ങൾ', 'Continue to official website': 'ഔദ്യോഗിക വെബ്സൈറ്റിലേക്ക് പോകുക', 'TELANGANA-FIRST': 'തെലങ്കാനയ്ക്ക് മുൻഗണന', 'Recommended for local farmers': 'പ്രാദേശിക കർഷകർക്കുള്ള ശുപാർശ', 'Crop emergency': 'വിള അടിയന്തരാവസ്ഥ', 'FARMER PRIORITY SUPPORT': 'കർഷക മുൻഗണനാ സഹായം', 'What happened?': 'എന്താണ് സംഭവിച്ചത്?', 'Choose the closest problem to get the next safest action.': 'ഏറ്റവും അനുയോജ്യമായ പ്രശ്നം തിരഞ്ഞെടുത്ത് അടുത്ത സുരക്ഷിത നടപടി നേടൂ.', 'DO THIS NOW': 'ഇപ്പോൾ ചെയ്യുക', 'Contact the FarmDirect quality desk': 'FarmDirect ഗുണനിലവാര സഹായവുമായി ബന്ധപ്പെടുക', 'WhatsApp now': 'ഇപ്പോൾ WhatsApp ചെയ്യുക', 'WhatsApp help': 'WhatsApp സഹായം', 'Sudden pest attack': 'പെട്ടെന്നുള്ള കീടാക്രമണം', 'Leaf disease or rot': 'ഇലരോഗം അല്ലെങ്കിൽ ചീഞ്ഞുപോകൽ', 'Storm, flood, or heat damage': 'കാറ്റ്, വെള്ളപ്പൊക്കം അല്ലെങ്കിൽ ചൂട് നാശം', 'Food quality or safety concern': 'ഭക്ഷണ ഗുണനിലവാരമോ സുരക്ഷയോ സംബന്ധിച്ച ആശങ്ക'
  }
};

const retailConnectNames = {
  en: 'Retail Connect',
  hi: 'खुदरा संपर्क',
  te: 'రిటైల్ కనెక్ట్',
  ta: 'சில்லறை இணைப்பு',
...
const navigationNames = {
  farmerHelp: { en: 'Farmer Help Desk', hi: 'किसान सहायता केंद्र', te: 'రైతు సహాయ కేంద్రం', ta: 'விவசாயி உதவி மையம்', kn: 'ರೈತ ಸಹಾಯ ಕೇಂದ್ರ', ml: 'കർഷക സഹായകേന്ദ്രം' },
  nearbyMarkets: { en: 'Nearby markets', hi: 'पास के बाजार', te: 'సమీప మార్కెట్లు', ta: 'அருகிலுள்ள சந்தைகள்', kn: 'ಹತ್ತಿರದ ಮಾರುಕಟ್ಟೆಗಳು', ml: 'സമീപ വിപണികൾ' },
  machineryShare: { en: 'Machinery share', hi: 'मशीनरी साझा करें', te: 'యంత్రాల భాగస్వామ్యం', ta: 'இயந்திரப் பகிர்வு', kn: 'ಯಂತ್ರ ಹಂಚಿಕೆ', ml: 'യന്ത്ര പങ്കിടൽ' }
};

function localizeSupportSurfaces(language) {
  const dictionaries = Object.values(supportSurfaceTranslations);
  const lookup = new Map();
  dictionaries.forEach((dictionary) => Object.entries(dictionary).forEach(([source, value]) => lookup.set(value, supportSurfaceTranslations[language]?.[source] || source)));
  Object.values(retailConnectNames).forEach((name) => lookup.set(name, retailConnectNames[language]));
  Object.values(navigationNames).forEach((names) => Object.values(names).forEach((name) => lookup.set(name, names[language])));
  const update = () => {
    document.querySelectorAll('.topbar, .connect-page, .farmer-help-page, .crop-emergency-button, .crop-emergency-modal, .whatsapp-support').forEach((surface) => {
      ...
      nodes.forEach((textNode) => {
        ...
        if (translated && translated !== trimmed) textNode.nodeValue = textNode.nodeValue.replace(trimmed, translated);
      });
    });
  };
  update();
...
function App() {
  useEffect(() => {
    const replaceBrandText = () => {
      ...
      textNodes.forEach((textNode) => {
        if (textNode.nodeValue.includes('Farmers A to Z') || textNode.nodeValue.includes('Seeds to Sale')) textNode.nodeValue = textNode.nodeValue.replaceAll('Farmers A to Z', 'Seeds 2 Sale').replaceAll('Seeds to Sale', 'Seeds 2 Sale');
      });
      const brandName = document.querySelector('.topbar .brand > span');
      if (brandName && brandName.textContent !== 'Seeds 2 Sale') brandName.textContent = 'Seeds 2 Sale';
      document.querySelectorAll('[aria-label], [alt], [title]').forEach((element) => {
        ['aria-label', 'alt', 'title'].forEach((attribute) => {
          const value = element.getAttribute(attribute);
          if (value?.includes('Farmers A to Z') || value?.includes('Seeds to Sale')) element.setAttribute(attribute, value.replaceAll('Farmers A to Z', 'Seeds 2 Sale').replaceAll('Seeds to Sale', 'Seeds 2 Sale'));
        });
      });
    };
    replaceBrandText();
    document.title = 'Seeds 2 Sale | From the field, fairly priced';
  ...
  useEffect(() => {
    const observer = localizeSupportSurfaces(language);
    return () => observer.disconnect();
  }, [language]);
  ...
  const navItems = role === 'delivery_partner'
    ...
    : role === 'farmer'
    ? [['farmer', t('farmer'), Sprout], ['farmer-help', 'Farmer Help Desk', Search], ['nearby-markets', 'Nearby markets', MapPin], ['add-listing', t('addProduce'), Plus], ['machinery', 'Machinery share', TractorIcon], ['inputs', t('farmInputs'), Store], ['radar', t('radar'), Radar], ['orders', t('previousOrders'), Truck], ['reviews', t('reviews'), Star]]
...
function CropRescuePlanner({ produce }) {
  const [selectedId, setSelectedId] = useState(produce[0]?.id || '');
  ...
  const [freshness, setFreshness] = useState('Good');
  const [plan, setPlan] = useState(null);
  const selected = produce.find((item) => String(item.id) === String(selectedId)) || produce[0] || {};
  const ageDays = Math.max(0, Math.floor((Date.now() - new Date(`${harvestDate}T00:00:00`).getTime()) / 86400000));
  const riskLevel = ageDays >= 3 || freshness === 'Needs selling today' ? 'HIGH' : ageDays >= 1 || freshness === 'Good' ? 'WATCH' : 'LOW';
  const riskMessage = riskLevel === 'HIGH' ? 'This crop is at risk right now. Match buyers before value drops.' : riskLevel === 'WATCH' ? 'Demand should be secured soon to protect freshness and price.' : 'Fresh harvest detected. You can still plan the best outlet.';
  const buyers = [
    { name: 'Nearby restaurant', kind: 'Restaurant', capacity: 300, rate: 0.98, distance: '4 km', delivery: 'Pickup in 45 min', areas: ['pune', 'anand', 'hyderabad', 'karnal'], icon: Store, phone: '+919876543210' },
    { name: 'Local consumers', kind: 'Consumers', capacity: 200, rate: 1, distance: '2 km', delivery: 'Community pickup today', areas: ['pune', 'jalandhar', 'karnal', 'hyderabad'], icon: ShoppingBasket, phone: '+919812345678' },
    { name: 'Processing unit', kind: 'Processor', capacity: 300, rate: 0.82, distance: '12 km', delivery: 'Bulk van in 2 hours', areas: ['ratnagiri', 'gulbarga', 'sehore', 'hoshangabad'], icon: PackageCheck, phone: '+919812345678' }
  ];
  const createPlan = () => {
    const locationText = location.toLowerCase();
    let remaining = Math.max(0, quantity);
    const basePrice = Number(selected.farmPrice) || 0;
    const sortedBuyers = [...buyers].sort((first, second) => {
      const firstScore = (first.areas.some((area) => locationText.includes(area)) ? 2 : 0) + (first.rate * 2);
      const secondScore = (second.areas.some((area) => locationText.includes(area)) ? 2 : 0) + (second.rate * 2);
      return secondScore - firstScore;
    });
    const allocations = sortedBuyers.map((buyer) => {
      const assigned = Math.min(remaining, buyer.capacity);
      remaining -= assigned;
      return { ...buyer, assigned, suggestedPrice: Math.round(basePrice * buyer.rate) };
    }).filter((buyer) => buyer.assigned > 0);
    setPlan({ allocations, remaining, totalValue: allocations.reduce((sum, buyer) => sum + buyer.assigned * buyer.suggestedPrice, 0) });
  };
  const updateCrop = (event) => { const item = produce.find((entry) => String(entry.id) === event.target.value); if (!item) return; setSelectedId(item.id); setQuantity(Number(item.quantity) || 1); setLocation(item.location || ''); setPlan(null); };
  const contactBuyer = (buyer) => window.open(whatsappLink(buyer.phone, `Hello, I have ${buyer.assigned} ${selected.unit || 'units'} of ${selected.name} ready near ${location}. Can you confirm the ${buyer.delivery.toLowerCase()}?`), '_blank', 'noopener,noreferrer');
  return <section className="rescue-tool page-enter"><div className="rescue-heading"><div><div className="eyebrow muted"><AlertTriangle size={13} /> CROP RESCUE</div><h2>Rescue My Harvest</h2><p>Tell us what may spoil. We will actively match the fastest nearby outlets and split the crop when one buyer cannot take it all.</p></div><div className={`rescue-age ${riskLevel === 'HIGH' ? 'urgent' : ''}`}><strong>{riskLevel} RISK</strong><span>{riskMessage}</span></div></div><div className="rescue-form"><label className="field"><span>Crop</span><select value={selected.id || ''} onChange={updateCrop}>{produce.map((item) => <option key={item.id} value={item.id}>{item.name}</option>)}</select></label><label className="field"><span>At-risk quantity ({selected.unit || 'units'})</span><input type="number" min="1" max={selected.quantity || 1} value={quantity} onChange={(event) => { setQuantity(Math.max(1, Math.min(Number(selected.quantity) || 1, Number(event.target.value) || 1))); setPlan(null); }} /></label><label className="field"><span>Farm location</span><input value={location} onChange={(event) => { setLocation(event.target.value); setPlan(null); }} placeholder="Village, district, or city" /></label><label className="field"><span>Harvest date</span><input type="date" value={harvestDate} onChange={(event) => { setHarvestDate(event.target.value); setPlan(null); }} /></label><label className="field"><span>Quality and freshness</span><select value={freshness} onChange={(event) => { setFreshness(event.target.value); setPlan(null); }}><option>Fresh</option><option>Good</option><option>Needs selling today</option></select></label><button type="button" className="primary-button rescue-plan-button" onClick={createPlan}><AlertTriangle size={16} /> Find rescue buyers</button></div>{plan && <div className="rescue-plan"><div className="rescue-plan-summary"><div><span className="panel-kicker">LIVE RESCUE PLAN</span><h3>{selected.name} can move through {plan.allocations.length} buyer{plan.allocations.length === 1 ? '' : 's'}</h3></div><strong>Estimated recovery {money(plan.totalValue)}</strong></div><div className="rescue-split-grid">{plan.allocations.map((buyer) => { const Icon = buyer.icon; return <article className="rescue-split-card" key={buyer.kind}><div className="rescue-buyer-icon"><Icon size={17} /></div><div><strong>{buyer.assigned} {selected.unit || 'units'} → {buyer.name}</strong><span>{buyer.kind} · {money(buyer.suggestedPrice)}/{selected.unit || 'unit'} suggested</span><small>{buyer.distance} · {buyer.delivery}</small></div><button type="button" className="rescue-contact" onClick={() => contactBuyer(buyer)}><MessageCircle size={14} /> Contact</button></article>; })}</div>{plan.remaining > 0 && <p className="rescue-unassigned">{plan.remaining} {selected.unit || 'units'} still need a buyer. Try lowering the price or widening the pickup radius.</p>}</div>}</section>;
}

function UnsoldProduceRescue({ produce }) {
  return <CropRescuePlanner produce={produce} />;
}

function LegacyUnsoldProduceRescue({ produce }) {
  const [selectedId, setSelectedId] = useState(produce[0]?.id || '');
  const [quantity, setQuantity] = useState(Number(produce[0]?.quantity) || 1);
  const [location, setLocation] = useState(produce[0]?.location || '');
  const [harvestDate, setHarvestDate] = useState(new Date().toISOString().slice(0, 10));
...
function VoiceNavigationAssistant({ language, onNavigate, onAddListing, onFarmerNeed }) {
  const [listening, setListening] = useState(false);
  ...
  const handleCommand = (transcript) => {
    const commandTarget = findNavigationTarget(transcript);
    if (commandTarget) {
      const { target, label } = commandTarget;
      speak(label);
    ...
    const need = detectFarmerNeed(transcript);
    if (need) {
      speak(`Opening ${need.toLowerCase()}.`);
      onFarmerNeed(need);
      return;
    }

    speak('I could not match that request to a page. Please try again.');
  };
  const listen = () => { const Recognition = speechRecognition(); if (!Recognition) { speak('Voice input is not supported in this browser.'); return; } if (listening) { recognitionRef.current?.abort(); return; } const recognition = new Recognition(); recognition.lang = `${languageCode}, en-US, hi-IN, te-IN, ta-IN, kn-IN, ml-IN`; recognition.interimResults = false; recognition.continuous = false; recognition.maxAlternatives = 1; recognition.onstart = () => { setListening(true); setMessage('Listening...'); }; recognition.onresult = (event) => { const transcript = event.results?.[0]?.[0]?.transcript?.trim() || ''; const need = detectFarmerNeed(transcript); if (need) { speak(`Opening ${need.toLowerCase()}.`); onFarmerNeed(need); return; } handleCommand(transcript); }; recognition.onerror = () => speak('I could not hear that. Please try again.'); recognition.onend = () => setListening(false); recognitionRef.current = recognition; try { recognition.start(); } catch { setListening(false); } };
...
const farmerOfficialServices = [
  { id: 'pm-kisan', title: 'PM-KISAN', category: 'Income support', useCase: 'I want to check my PM-KISAN status', description: 'Income support for eligible farmers with registration, e-KYC, and beneficiary status updates.', url: 'https://pmkisan.gov.in/', provider: 'Official government portal', keywords: ['loan', 'money', 'financial', 'income', 'pm-kisan', 'status'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'kisan-rin', title: 'Kisan Rin Portal', category: 'Loans & Financial Support', useCase: 'I need a farming loan', description: 'Kisan Credit Card, scheme information, credit access guidance, and related delivery channels.', url: 'https://fasalrin.gov.in/', provider: 'Fasal Rin', keywords: ['loan', 'credit', 'kcc', 'finance', 'money'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'pmfby', title: 'PM Fasal Bima Yojana', category: 'Crop Insurance & Compensation', useCase: 'I need crop insurance', description: 'Crop insurance enrollment, premium information, policy status, loss reporting and grievance support.', url: 'https://www.pmfby.gov.in/', provider: 'PMFBY - Crop Insurance', keywords: ['insurance', 'crop', 'damage', 'compensation', 'premium'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'enam', title: 'e-NAM', category: 'Markets & Selling', useCase: 'I want to sell my crops', description: 'Electronic agricultural trading platform connecting mandis and helping farmers find buyers and price discovery.', url: 'https://enam.gov.in/', provider: 'National Agriculture Market', keywords: ['sell', 'market', 'mandi', 'price', 'buyer', 'trade'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'soil-health', title: 'Soil Health Card', category: 'Soil, Seeds & Fertilizers', useCase: 'I need soil testing information', description: 'Soil testing and fertilizer recommendations based on soil health and nutrient information.', url: 'https://soilhealth.dac.gov.in/', provider: 'Soil Health Card portal', keywords: ['soil', 'fertilizer', 'testing', 'nutrition', 'seed'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'aif', title: 'Agriculture Infrastructure Fund', category: 'Loans & Financial Support', useCase: 'I need infra finance', description: 'Financing for eligible post-harvest infrastructure and community farming assets.', url: 'https://agriinfra.dac.gov.in/', provider: 'Government of India', keywords: ['infrastructure', 'loan', 'finance', 'warehouse', 'cold storage'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'midh', title: 'MIDH', category: 'Government Schemes', useCase: 'I need horticulture support', description: 'Scheme and programme information for horticulture and related government assistance.', url: 'https://midh.gov.in/', provider: 'Mission for Integrated Development of Horticulture', keywords: ['horticulture', 'scheme', 'state', 'support'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'telangana-agri', title: 'Telangana Agriculture Department', category: 'Government Schemes', useCase: 'I need Telangana agriculture services', description: 'State agriculture schemes, department notices, and official farmer-related announcements.', url: 'https://www.telangana.gov.in/', provider: 'Telangana State Portal', keywords: ['telangana', 'state', 'scheme', 'agriculture'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'kisan-suvidha', title: 'Kisan Suvidha', category: 'Learning & Expert Help', useCase: 'I need agricultural information', description: 'A government-linked agriculture information portal bringing together useful digital services.', url: 'https://www.india.gov.in/', provider: 'National Portal of India', keywords: ['advisory', 'info', 'support', 'government'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'agmarknet', title: 'Agmarknet', category: 'Markets & Selling', useCase: 'I want price information', description: 'Market price and arrival information including minimum, modal and maximum commodity prices.', url: 'https://agmarknet.gov.in/', provider: 'Agmarknet price dashboard', keywords: ['price', 'market', 'mandi', 'selling'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'pmfby-learning', title: 'PMFBY Learning Portal', category: 'Learning & Expert Help', useCase: 'I need training or guidance', description: 'Learning resources on crop insurance and agricultural credit, including KCC training materials.', url: 'https://pmfby.gov.in/', provider: 'Farmer insurance training and courses', keywords: ['training', 'learning', 'kcc', 'insurance', 'support'], lastVerified: 'Last verified: Sep 2026' },
  { id: 'india-services', title: 'National Government Services Portal', category: 'Government Schemes', useCase: 'I need help finding a government service', description: 'A searchable directory for central and state agriculture-related public services.', url: 'https://services.india.gov.in/', provider: 'National Government Services Portal', keywords: ['service', 'government', 'scheme', 'district', 'state'], lastVerified: 'Last verified: Sep 2026' }
];

const farmerHelpCategories = ['All', 'Loans & Financial Support', 'Crop Insurance & Compensation', 'Markets & Selling', 'Soil, Seeds & Fertilizers', 'Government Schemes', 'Learning & Expert Help'];
const farmerQuickNeeds = ['I need a farming loan', 'I need crop insurance', 'I want to check my PM-KISAN status', 'I want to sell my crops', 'I need soil testing information', 'I need Telangana agriculture services'];

function FarmerHelpDesk() {
  const [selectedNeed, setSelectedNeed] = useState(() => load('farmer-help-need', 'I need a farming loan'));
  const [selectedCategory, setSelectedCategory] = useState('All');

  const visibleServices = farmerOfficialServices.filter((service) => {
    const matchesCategory = selectedCategory === 'All' || service.category === selectedCategory;
    const matchesNeed = selectedNeed === 'I need a farming loan' ? service.keywords.some((keyword) => ['loan', 'credit', 'finance', 'money'].includes(keyword)) : selectedNeed === 'I need crop insurance' ? service.category === 'Crop Insurance & Compensation' : selectedNeed === 'I want to check my PM-KISAN status' ? service.id === 'pm-kisan' : selectedNeed === 'I want to sell my crops' ? service.category === 'Markets & Selling' : selectedNeed === 'I need soil testing information' ? service.category === 'Soil, Seeds & Fertilizers' : selectedNeed === 'I need Telangana agriculture services' ? service.category === 'Government Schemes' : true;
    return matchesCategory && matchesNeed;
  });

  return <section className="farmer-help-page page-enter"><div className="page-header"><div><div className="eyebrow"><span></span> ONE-STOP FARMER SERVICES</div><h1>Farmer <em>Help Desk</em></h1><p>Skip the scattered Google search. Use a single official hub for loans, crop insurance, market access, soil support, and state schemes relevant to farmers across Telangana and India.</p></div></div><div className="help-grid"><div className="help-panel"><div className="help-quick"><div className="panel-kicker">WHAT DO YOU NEED HELP WITH?</div><div className="help-need-list">{farmerQuickNeeds.map((need) => <button key={need} type="button" className={selectedNeed === need ? 'selected' : ''} onClick={() => setSelectedNeed(need)}>{need}</button>)}</div></div><div className="filter-row"><span className="panel-kicker">SERVICE CATEGORIES</span><div className="category-row help-categories">{farmerHelpCategories.map((category) => <button key={category} type="button" className={selectedCategory === category ? 'selected' : ''} onClick={() => setSelectedCategory(category)}>{category}</button>)}</div></div><div className="service-list">{visibleServices.map((service) => <article key={service.id} className="service-card" aria-label={`${service.title} service card`}><div className="service-head"><div><span className="service-icon">{service.title.split(' ')[0][0]}</span></div><div><span className="service-category">{service.category}</span><h3>{service.title}</h3></div></div><p>{service.description}</p><div className="service-meta"><span>{service.provider}</span><strong>{service.lastVerified}</strong></div><div className="service-actions"><button type="button" onClick={() => window.open(service.url, '_blank', 'noopener,noreferrer')} className="primary-button">Continue to official website <ArrowRight size={15} /></button></div></article>)}</div></div><aside className="help-sidebar"><div className="help-sidebar-card"><div className="panel-kicker">TELANGANA-FIRST</div><h2>Recommended for local farmers</h2><ul><li>PM-KISAN beneficiary and status checks</li><li>KCC and agriculture credit guidance</li><li>PMFBY crop insurance and claims support</li><li>e-NAM and mandi price discovery</li><li>Soil Health Card and input guidance</li><li>State agriculture and district-specific updates</li></ul></div><div className="help-sidebar-card warning"><div className="panel-kicker">BEFORE APPLYING</div><h2>Check the latest details</h2><p>Scheme eligibility, application windows, crop coverage and benefits can vary by state, season, and farmer category. Always confirm the latest rules with the relevant department before applying.</p></div></aside></div></section>;
}
...
function CustomerCareChatbot() {
  const [open, setOpen] = useState(false);
  const [selectedQuestion, setSelectedQuestion] = useState(null);
  const questions = [
    { question: 'Where is my order?', answer: 'Open Orders from the top menu to see the latest status, delivery partner, and estimated delivery time.' },
    { question: 'How do I place an order?', answer: 'Choose a produce item, select Buy now or add it to your cart, then complete your address, delivery, and payment details.' },
    { question: 'Which payment methods work?', answer: 'You can pay with Cash on Delivery, UPI, PhonePe, or Google Pay. Payment confirmation is required before dispatch for online payments.' },
    { question: 'I am a farmer. How do I get help?', answer: 'Use Farmer Help Desk for crop and scheme guidance, or contact our support team directly through WhatsApp, phone, or email below.' },
    { question: 'How can I report a food-quality issue?', answer: 'Pause the order and contact the quality desk immediately. Share the order number, crop name, photos, and what you noticed.' }
  ];
  const message = selectedQuestion?.answer || 'Hi! I can answer common questions about orders, payments, delivery, and farmer support.';
  const whatsappMessage = selectedQuestion ? `Hello, I need help with: ${selectedQuestion.question}` : 'Hello, I need customer care support.';
  return <div className={`customer-care-chatbot ${open ? 'is-open' : ''}`}>
    {open && <section className="customer-care-chat-panel" role="dialog" aria-modal="false" aria-labelledby="customer-care-title">
      <div className="customer-care-chat-heading"><div><span className="panel-kicker">FARMERS A TO Z</span><h2 id="customer-care-title">Customer care</h2></div><button type="button" onClick={() => setOpen(false)} aria-label="Close customer care"><X size={17} /></button></div>
      <div className="customer-care-message"><Headphones size={16} /><p>{message}</p></div>
      <div className="customer-care-questions">{questions.map((item) => <button type="button" className={selectedQuestion?.question === item.question ? 'selected' : ''} key={item.question} onClick={() => setSelectedQuestion(item)}>{item.question}</button>)}</div>
      <div className="customer-care-contact"><span>Need a person?</span><div><a href={`mailto:support@farmersatoz.in?subject=${encodeURIComponent(selectedQuestion?.question || 'Customer care support')}`} title="Email customer care" aria-label="Email customer care"><Mail size={15} /></a><a href={`tel:${WHATSAPP_HELP_LINE}`} title="Call customer care" aria-label="Call customer care"><Phone size={15} /></a><a href={whatsappLink(WHATSAPP_HELP_LINE, whatsappMessage)} target="_blank" rel="noreferrer" title="Chat on WhatsApp" aria-label="Chat on WhatsApp"><MessageCircle size={15} /></a></div></div>
    </section>}
    <button className="customer-care-launcher" type="button" onClick={() => setOpen((current) => !current)} aria-expanded={open} aria-label={open ? 'Close customer care chat' : 'Open customer care chat'}><Headphones size={18} /><span>Customer care</span></button>
  </div>;
}

createRoot(document.getElementById('root')).render(<><LanguageProvider><App /></LanguageProvider><CropEmergency /><WhatsAppSupport /><CustomerCareChatbot /></>);